...
@implementation MuangthaiAppDelegate
...
- (id)getRetirePageEnable:(int)getterRetirePageEnable getTaxPageEnable:(int)getterTaxPageEnable getEducationPageEnable:(int)getterEducationPageEnable getAssurancePageEnable:(int)getterAssurancePageEnable getSavingPageEnable:(int)getterSavingPageEnable{
    self.RetirePageEnable = getterRetirePageEnable;
    self.TaxPageEnable = getterTaxPageEnable;
    self.EducationPageEnable = getterEducationPageEnable;
    self.AssurancePageEnable = getterAssurancePageEnable;
    self.SavingPageEnable = getterSavingPageEnable;
    return self;
}
